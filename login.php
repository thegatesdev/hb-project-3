...
if (!$conn) {
    $message = "Kon niet verbinden met de server!";
    ...
    $err = gdb_validate($conn, $login_settings, $input_username, $input_pwd);
    ...
    if ($input_pwd === $input_pwd_check) {
        $err = gdb_create($conn, $login_settings, $input_username, $input_pwd);
